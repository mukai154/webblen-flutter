              ...
              title: Container(
                child: Column(
                  children: <Widget>[
                    ...
                    SizedBox(height: 8.0),
                    Text("What is Powering Up?", style: Fonts.alertDialogHeader, textAlign: TextAlign.center),
                  ],
                ),
              ),
              content: new Text('Powering up is converting your points into "impact". Impact increase the value of your attendance at events.', style: Fonts.alertDialogBody, textAlign: TextAlign.center),
              actions: <Widget>[
                new FlatButton(
