...
import 'package:webblen/community_pages/communities_page.dart';
...
class PageTransitionService{
  ...
  PageTransitionService({
    ...
    this.newsPost, this.reward, this.event, this.eventKey,
...
//  void transitionToEventEditPage () =>  Navigator.push(context, SlideFromRightRoute(widget: EventEditPage(event: event, currentUser: currentUser, eventIsLive: eventIsLive)));
  ...
  void transitionToEventAttendeesPage () =>  Navigator.push(context, SlideFromRightRoute(widget: EventAttendeesPage(currentUser: currentUser, eventKey: eventKey,)));
  void transitionToUserRanksPage () =>  Navigator.push(context, SlideFromRightRoute(widget: UserRanksPage()));
  void transitionToCreateRewardPage () =>  Navigator.push(context, SlideFromRightRoute(widget: CreateRewardPage()));
  void transitionToFriendsPage () =>  Navigator.push(context, SlideFromRightRoute(widget: FriendsPage(uid: uid)));
  ...
  void transitionToCurrentUserDetailsPage () =>  Navigator.push(context, SlideFromRightRoute(widget: CurrentUserDetailsPage(currentUser: currentUser)));
  ...
  void transitionToDiscoverPage () =>  Navigator.push(context, SlideFromRightRoute(widget: DiscoverPage(uid: uid, areaName: areaName)));
  void transitionToMyCommunitiesPage () =>  Navigator.push(context, SlideFromRightRoute(widget: MyCommunitiesPage(uid: uid, areaName: areaName)));
  void transitionToNewCommunityPage () =>  Navigator.push(context, SlideFromRightRoute(widget: CreateCommunityPage(areaName: areaName)));
...
//  void transitionToCommunityBuilderPage () => Navigator.push(context, SlideFromRightRoute(widget: CommunityCreatePostPage(currentUser: currentUser, community: community)));
  ...
  void transitionToSearchPage () => Navigator.push(context, SlideFromRightRoute(widget: SearchPage(currentUser: currentUser, areaName: areaName)));
